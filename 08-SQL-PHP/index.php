...
$statement = $conexion -> prepare("INSERT INTO `estudiantes` (`ID` ,`Nombre`, `Edad`,`Grado`, `Media técnica`) VALUES (NULL, :nombre, '16', '11', :media)");

//ejecutar el statement

$statement -> execute(array( ":nombre"=>$nombre, ":media"=>$media));
